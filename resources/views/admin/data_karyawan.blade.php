...
<br/><br/>
                        ...
                        @php $iter=1;@endphp
                          @foreach ($data_user as $k => $v)
                            <tr>
                              ...
                              <td nowrap>{{$v->tanggal_lahir}}</td>
                              <td nowrap>{{$v->jabatan->jabatan}}</td>
    ...
    <script src="/template/moment/min/moment.min.js"></script>
    <script src="/template/bootstrap-daterangepicker/daterangepicker.js"></script>
